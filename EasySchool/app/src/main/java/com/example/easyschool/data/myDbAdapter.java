...
public class myDbAdapter {
    ...
    public long insertData(String name, String phone, String mail,String password,String level)
    {
        SQLiteDatabase dbb = myhelper.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(myDbHelper.NAME, name);
        contentValues.put(myDbHelper.level, level);
    ...
    public String[] getData_inf()
    {
        ...
        String[] columns = {myDbHelper.UID,myDbHelper.Email,myDbHelper.MyPASSWORD,myDbHelper.NAME
                ,myDbHelper.phone,myDbHelper.level};
        Cursor cursor =db.query(myDbHelper.TABLE_NAME,columns,null,null,null,null,null);
        StringBuffer buffer= new StringBuffer();
        while (cursor.moveToNext())
        {
            ...
            Sl= new String[]{name, mail, phone ,level};
        }
        return Sl;
    }
    ...
    static class myDbHelper extends SQLiteOpenHelper
    {
        ...
        private static final String level = "Level";    //Column V
        ...
        private static final String CREATE_TABLE = "CREATE TABLE "+TABLE_NAME+
                ...
                MyPASSWORD+" VARCHAR(225) , "+ Email+" VARCHAR(225) , "+ level+" VARCHAR(225) , "+ phone+" VARCHAR(225));";
